...
### 5. Запустите автоматическую генерацию голосовых файлов для Asterisk
...
Заполните созданный файл или создайте свой (например, my_phrases.txt) в формате имя_файла|текст например:
